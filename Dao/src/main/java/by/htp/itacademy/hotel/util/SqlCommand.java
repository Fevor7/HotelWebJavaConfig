...
//	public static final String SQL_SIZE = "SELECT FOUND_ROWS()";
	...
	public static final String SELECT_ROOM_ALL = "select r from Room r";
	public static final String SELECT_ROOM_ALL_COUNT = "select count(id) from Room";

	public static final String SELECT_ROOM_SEARCH = "SELECT * FROM hotel.room r WHERE(r.id IN (SELECT id_room FROM hotel.order_table WHERE ((dateStart NOT BETWEEN ?1 AND ?2)AND(dateEnd NOT BETWEEN ?3 AND ?4)) OR (id_status=4 or id_status=1 ) )  OR r.id NOT IN (SELECT id_room FROM hotel.order_table WHERE id_room!='' or id_room!=0)) AND (price>=?5) AND (price<=?6) AND (person>=?7) AND (bed>=?8)";
	public static final String SELECT_ROOM_SEARCH_COUNT = "SELECT count(*) FROM hotel.room r WHERE(r.id IN (SELECT id_room FROM hotel.order_table WHERE ((dateStart NOT BETWEEN ?1 AND ?2)AND(dateEnd NOT BETWEEN ?3 AND ?4)) OR (id_status=4 or id_status=1 ) )  OR r.id NOT IN (SELECT id_room FROM hotel.order_table WHERE id_room!='' or id_room!=0)) AND (price>=?5) AND (price<=?6) AND (person>=?7) AND (bed>=?8)";
	public static final String SELECT_ROOM_SEARCH_TYPE = "SELECT * FROM hotel.room r WHERE(r.id IN (SELECT id_room FROM hotel.order_table WHERE ((dateStart NOT BETWEEN ?1 AND ?2)AND(dateEnd NOT BETWEEN ?3 AND ?4)) OR (id_status=4 or id_status=1 ) )  OR r.id NOT IN (SELECT id_room FROM hotel.order_table WHERE id_room!='' or id_room!=0)) AND (id_type = ?9) AND (price>=?5) AND (price<=?6) AND (person>=?7) AND (bed>=?8)";
	public static final String SELECT_ROOM_SEARCH_TYPE_COUNT = "SELECT count(*) FROM hotel.room r WHERE(r.id IN (SELECT id_room FROM hotel.order_table WHERE ((dateStart NOT BETWEEN ?1 AND ?2)AND(dateEnd NOT BETWEEN ?3 AND ?4)) OR (id_status=4 or id_status=1 ) )  OR r.id NOT IN (SELECT id_room FROM hotel.order_table WHERE id_room!='' or id_room!=0)) AND (id_type = ?9) AND (price>=?5) AND (price<=?6) AND (person>=?7) AND (bed>=?8)";
	
	public static final String SELECT_ROOM_SEARCH_ADMIN = "SELECT * FROM hotel.room r WHERE(r.id IN (SELECT id_room FROM hotel.order_table WHERE ((dateStart NOT BETWEEN ?1 AND ?2)AND(dateEnd NOT BETWEEN ?3 AND ?4)) OR (id_status=4 or id_status=1 ) )  OR r.id NOT IN (SELECT id_room FROM hotel.order_table WHERE id_room!='' or id_room!=0)) AND (person>=?7) AND (bed>=?8)";
	public static final String SELECT_ROOM_SEARCH_COUNT_ADMIN = "SELECT count(*) FROM hotel.room r WHERE(r.id IN (SELECT id_room FROM hotel.order_table WHERE ((dateStart NOT BETWEEN ?1 AND ?2)AND(dateEnd NOT BETWEEN ?3 AND ?4)) OR (id_status=4 or id_status=1 ) )  OR r.id NOT IN (SELECT id_room FROM hotel.order_table WHERE id_room!='' or id_room!=0)) AND (person>=?7) AND (bed>=?8)";
	public static final String SELECT_ROOM_SEARCH_TYPE_ADMIN = "SELECT * FROM hotel.room r WHERE(r.id IN (SELECT id_room FROM hotel.order_table WHERE ((dateStart NOT BETWEEN ?1 AND ?2)AND(dateEnd NOT BETWEEN ?3 AND ?4)) OR (id_status=4 or id_status=1 ) )  OR r.id NOT IN (SELECT id_room FROM hotel.order_table WHERE id_room!='' or id_room!=0))AND (id_type = ?9) AND (person>=?7) AND (bed>=?8)";
	public static final String SELECT_ROOM_SEARCH_TYPE_COUNT_ADMIN = "SELECT count(*) FROM hotel.room r WHERE(r.id IN (SELECT id_room FROM hotel.order_table WHERE ((dateStart NOT BETWEEN ?1 AND ?2)AND(dateEnd NOT BETWEEN ?3 AND ?4)) OR (id_status=4 or id_status=1 ) )  OR r.id NOT IN (SELECT id_room FROM hotel.order_table WHERE id_room!='' or id_room!=0)) AND (id_type = ?9) AND (bed>=?8)AND (person>=?7) ";
